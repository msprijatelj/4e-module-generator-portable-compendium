...
if __name__ == '__main__':
    ...
    try:
        os.remove('export/mods/4E_Magic_Items.mod')
    except FileNotFoundError:
        print("Cleanup not needed.")
    try:
        shutil.make_archive('export/mods/4E_Magic_Items', 'zip', 'export/magic_items/data/')
        os.rename('export/mods/4E_Magic_Items.zip', 'export/mods/4E_Magic_Items.mod')
        ...
        print("Rename the complete filename (including extension) to '4E_Magic_Items.mod'.\n")
